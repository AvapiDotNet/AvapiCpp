#ifndef PLUS_DM_HPP_INCLUDED
#define PLUS_DM_HPP_INCLUDED
...
enum class Const_PLUS_DM_interval{
    none,
    n_1min,
    n_5min,
    n_15min,
...
{
public:
    static const map<Const_PLUS_DM_interval, string> s_interval_translation;
};

class MetaData_Type_PLUS_DM
{
private:
    string Symbol;
    string Indicator;
...
public:
    MetaData_Type_PLUS_DM();
    MetaData_Type_PLUS_DM(const MetaData_Type_PLUS_DM& other); // copy constructor
...
class TechnicalIndicator_Type_PLUS_DM
{
private:
    string PLUS_DM;
    string DateTime;
...
public:
    TechnicalIndicator_Type_PLUS_DM();
    TechnicalIndicator_Type_PLUS_DM(const TechnicalIndicator_Type_PLUS_DM& other); // copy constructor

    string get_PLUS_DM() const {return PLUS_DM;};
    string get_DateTime() const {return DateTime;};
    void set_PLUS_DM(string PLUS_DM){this->PLUS_DM = PLUS_DM;};
    void set_DateTime(string DateTime){this->DateTime = DateTime;};

   int ParseInternal(string& str_data, jsmntok_t* array_token, int index, int token_size);
};

class AvapiResponse_PLUS_DM_Content
{
private:
    MetaData_Type_PLUS_DM MetaData;
    list<TechnicalIndicator_Type_PLUS_DM> TechnicalIndicator;
    string str_prefix;
    bool error_status;
    string ErrorMessage;

public:
    AvapiResponse_PLUS_DM_Content();
    ~AvapiResponse_PLUS_DM_Content() {};
    AvapiResponse_PLUS_DM_Content(const AvapiResponse_PLUS_DM_Content& other); // copy constructor
    MetaData_Type_PLUS_DM& get_MetaData() {return MetaData;};
    list<TechnicalIndicator_Type_PLUS_DM>& get_TechnicalIndicator() {return TechnicalIndicator;};
...
class AvapiResponse_PLUS_DM
{
private:
    string LastHttpRequest;
    string RawData;
    AvapiResponse_PLUS_DM_Content* Data;

public:
    AvapiResponse_PLUS_DM();
    AvapiResponse_PLUS_DM(const AvapiResponse_PLUS_DM& other); // copy constructor
    AvapiResponse_PLUS_DM(AvapiResponse_PLUS_DM&& other); // move constructor
    AvapiResponse_PLUS_DM& operator=(const AvapiResponse_PLUS_DM& other); //copy assignment
    AvapiResponse_PLUS_DM& operator=(AvapiResponse_PLUS_DM&& other); //move assignment
    ~AvapiResponse_PLUS_DM();

    AvapiResponse_PLUS_DM_Content& get_Data() const {return *Data;};
...
private:
    ...
    static Impl_PLUS_DM *s_instance;
    Impl_PLUS_DM() {};
    static const unsigned int START_TOKEN_SIZE = 3000;
    static void ParseInternal(AvapiResponse_PLUS_DM& Response);

public:
    static Impl_PLUS_DM& getInstance();
    ...
    AvapiResponse_PLUS_DM Query(string symbol
        ,Const_PLUS_DM_interval interval
        ,string time_period
        );
