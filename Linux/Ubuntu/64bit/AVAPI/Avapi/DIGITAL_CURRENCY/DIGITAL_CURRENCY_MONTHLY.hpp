#ifndef DIGITAL_CURRENCY_MONTHLY_HPP_INCLUDED
#define DIGITAL_CURRENCY_MONTHLY_HPP_INCLUDED
...
enum class Const_DIGITAL_CURRENCY_MONTHLY_datatype{
    none,
    json,
    csv,
};

class MAP_DIGITAL_CURRENCY_MONTHLY
{
public:
    static const map<Const_DIGITAL_CURRENCY_MONTHLY_datatype, string> s_datatype_translation;
};

class MetaData_Type_DIGITAL_CURRENCY_MONTHLY
{
private:
    string Information;
...
public:
    MetaData_Type_DIGITAL_CURRENCY_MONTHLY();
    MetaData_Type_DIGITAL_CURRENCY_MONTHLY(const MetaData_Type_DIGITAL_CURRENCY_MONTHLY& other); // copy constructor
...
class TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY
{
private:
    string Open;
    string OpenUSD;
...
public:
    TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY();
    TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY(const TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY& other); // copy constructor
...
class AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content
{
private:
    MetaData_Type_DIGITAL_CURRENCY_MONTHLY MetaData;
    list<TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY> TimeSeries;
    string str_prefix;
    bool error_status;
    string ErrorMessage;

public:
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content();
    ~AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content() {};
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content(const AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content& other); // copy constructor
    MetaData_Type_DIGITAL_CURRENCY_MONTHLY& get_MetaData() {return MetaData;};
    list<TimeSeries_Type_DIGITAL_CURRENCY_MONTHLY>& get_TimeSeries() {return TimeSeries;};
...
class AvapiResponse_DIGITAL_CURRENCY_MONTHLY
{
private:
    string LastHttpRequest;
    string RawData;
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content* Data;

public:
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY();
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY(const AvapiResponse_DIGITAL_CURRENCY_MONTHLY& other); // copy constructor
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY(AvapiResponse_DIGITAL_CURRENCY_MONTHLY&& other); // move constructor
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY& operator=(const AvapiResponse_DIGITAL_CURRENCY_MONTHLY& other); //copy assignment
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY& operator=(AvapiResponse_DIGITAL_CURRENCY_MONTHLY&& other); //move assignment
    ~AvapiResponse_DIGITAL_CURRENCY_MONTHLY();

    AvapiResponse_DIGITAL_CURRENCY_MONTHLY_Content& get_Data() const {return *Data;};
...
private:
    ...
    static Impl_DIGITAL_CURRENCY_MONTHLY *s_instance;
    Impl_DIGITAL_CURRENCY_MONTHLY() {};
    static const unsigned int START_TOKEN_SIZE = 3000;
    static void ParseInternal(AvapiResponse_DIGITAL_CURRENCY_MONTHLY& Response);

public:
    static Impl_DIGITAL_CURRENCY_MONTHLY& getInstance();
    ...
    AvapiResponse_DIGITAL_CURRENCY_MONTHLY Query(string symbol, string market
        ,Const_DIGITAL_CURRENCY_MONTHLY_datatype datatype  = Const_DIGITAL_CURRENCY_MONTHLY_datatype::none
        );
...
#endif // DIGITAL_CURRENCY_MONTHLY_HPP_INCLUDED
