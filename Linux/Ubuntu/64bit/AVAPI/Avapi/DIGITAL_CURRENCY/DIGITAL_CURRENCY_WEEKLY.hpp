#ifndef DIGITAL_CURRENCY_WEEKLY_HPP_INCLUDED
#define DIGITAL_CURRENCY_WEEKLY_HPP_INCLUDED
...
enum class Const_DIGITAL_CURRENCY_WEEKLY_datatype{
    none,
    json,
    csv,
};

class MAP_DIGITAL_CURRENCY_WEEKLY
{
public:
    static const map<Const_DIGITAL_CURRENCY_WEEKLY_datatype, string> s_datatype_translation;
};

class MetaData_Type_DIGITAL_CURRENCY_WEEKLY
{
private:
    string Information;
...
public:
    MetaData_Type_DIGITAL_CURRENCY_WEEKLY();
    MetaData_Type_DIGITAL_CURRENCY_WEEKLY(const MetaData_Type_DIGITAL_CURRENCY_WEEKLY& other); // copy constructor
...
class TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY
{
private:
    string Open;
    string OpenUSD;
...
public:
    TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY();
    TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY(const TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY& other); // copy constructor
...
class AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content
{
private:
    MetaData_Type_DIGITAL_CURRENCY_WEEKLY MetaData;
    list<TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY> TimeSeries;
    string str_prefix;
    bool error_status;
    string ErrorMessage;

public:
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content();
    ~AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content() {};
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content(const AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content& other); // copy constructor
    MetaData_Type_DIGITAL_CURRENCY_WEEKLY& get_MetaData() {return MetaData;};
    list<TimeSeries_Type_DIGITAL_CURRENCY_WEEKLY>& get_TimeSeries() {return TimeSeries;};
...
class AvapiResponse_DIGITAL_CURRENCY_WEEKLY
{
private:
    string LastHttpRequest;
    string RawData;
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content* Data;

public:
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY();
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY(const AvapiResponse_DIGITAL_CURRENCY_WEEKLY& other); // copy constructor
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY(AvapiResponse_DIGITAL_CURRENCY_WEEKLY&& other); // move constructor
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY& operator=(const AvapiResponse_DIGITAL_CURRENCY_WEEKLY& other); //copy assignment
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY& operator=(AvapiResponse_DIGITAL_CURRENCY_WEEKLY&& other); //move assignment
    ~AvapiResponse_DIGITAL_CURRENCY_WEEKLY();

    AvapiResponse_DIGITAL_CURRENCY_WEEKLY_Content& get_Data() const {return *Data;};
...
private:
    ...
    static Impl_DIGITAL_CURRENCY_WEEKLY *s_instance;
    Impl_DIGITAL_CURRENCY_WEEKLY() {};
    static const unsigned int START_TOKEN_SIZE = 3000;
    static void ParseInternal(AvapiResponse_DIGITAL_CURRENCY_WEEKLY& Response);

public:
    static Impl_DIGITAL_CURRENCY_WEEKLY& getInstance();
    ...
    AvapiResponse_DIGITAL_CURRENCY_WEEKLY Query(string symbol, string market
        ,Const_DIGITAL_CURRENCY_WEEKLY_datatype datatype  = Const_DIGITAL_CURRENCY_WEEKLY_datatype::none
        );
...
#endif // DIGITAL_CURRENCY_WEEKLY_HPP_INCLUDED
