#ifndef TIME_SERIES_WEEKLY_HPP_INCLUDED
#define TIME_SERIES_WEEKLY_HPP_INCLUDED
...
enum class Const_TIME_SERIES_WEEKLY_datatype{
    none,
    json,
    csv,
};

class MAP_TIME_SERIES_WEEKLY
{
public:
    static const map<Const_TIME_SERIES_WEEKLY_datatype, string> s_datatype_translation;
};

class MetaData_Type_TIME_SERIES_WEEKLY
{
private:
    string Information;
    string Symbol;
...
public:
    MetaData_Type_TIME_SERIES_WEEKLY();
    MetaData_Type_TIME_SERIES_WEEKLY(const MetaData_Type_TIME_SERIES_WEEKLY& other); // copy constructor
...
class TimeSeries_Type_TIME_SERIES_WEEKLY
{
private:
    string Open;
    string High;
...
public:
    TimeSeries_Type_TIME_SERIES_WEEKLY();
    TimeSeries_Type_TIME_SERIES_WEEKLY(const TimeSeries_Type_TIME_SERIES_WEEKLY& other); // copy constructor
...
class AvapiResponse_TIME_SERIES_WEEKLY_Content
{
private:
    MetaData_Type_TIME_SERIES_WEEKLY MetaData;
    list<TimeSeries_Type_TIME_SERIES_WEEKLY> TimeSeries;
    string str_prefix;
    bool error_status;
    string ErrorMessage;

public:
    AvapiResponse_TIME_SERIES_WEEKLY_Content();
    ~AvapiResponse_TIME_SERIES_WEEKLY_Content() {};
    AvapiResponse_TIME_SERIES_WEEKLY_Content(const AvapiResponse_TIME_SERIES_WEEKLY_Content& other); // copy constructor
    MetaData_Type_TIME_SERIES_WEEKLY& get_MetaData() {return MetaData;};
    list<TimeSeries_Type_TIME_SERIES_WEEKLY>& get_TimeSeries() {return TimeSeries;};
...
class AvapiResponse_TIME_SERIES_WEEKLY
{
private:
    string LastHttpRequest;
    string RawData;
    AvapiResponse_TIME_SERIES_WEEKLY_Content* Data;

public:
    AvapiResponse_TIME_SERIES_WEEKLY();
    AvapiResponse_TIME_SERIES_WEEKLY(const AvapiResponse_TIME_SERIES_WEEKLY& other); // copy constructor
    AvapiResponse_TIME_SERIES_WEEKLY(AvapiResponse_TIME_SERIES_WEEKLY&& other); // move constructor
    AvapiResponse_TIME_SERIES_WEEKLY& operator=(const AvapiResponse_TIME_SERIES_WEEKLY& other); //copy assignment
    AvapiResponse_TIME_SERIES_WEEKLY& operator=(AvapiResponse_TIME_SERIES_WEEKLY&& other); //move assignment
    ~AvapiResponse_TIME_SERIES_WEEKLY();

    AvapiResponse_TIME_SERIES_WEEKLY_Content& get_Data() const {return *Data;};
...
private:
    ...
    static Impl_TIME_SERIES_WEEKLY *s_instance;
    Impl_TIME_SERIES_WEEKLY() {};
    static const unsigned int START_TOKEN_SIZE = 3000;
    static void ParseInternal(AvapiResponse_TIME_SERIES_WEEKLY& Response);

public:
    static Impl_TIME_SERIES_WEEKLY& getInstance();
    ...
    AvapiResponse_TIME_SERIES_WEEKLY Query(string symbol
        ,Const_TIME_SERIES_WEEKLY_datatype datatype  = Const_TIME_SERIES_WEEKLY_datatype::none
        );
...
#endif // TIME_SERIES_WEEKLY_HPP_INCLUDED
