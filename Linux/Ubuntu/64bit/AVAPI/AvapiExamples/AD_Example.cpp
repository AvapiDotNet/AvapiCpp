...
#include "Avapi/TECHNICAL_INDICATOR/AD.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_AD();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_AD_interval::n_60min);

    cout << endl <<  "******** RAW DATA AD ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA AD ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "ChaikinAD: " << element.get_ChaikinAD() << endl;
