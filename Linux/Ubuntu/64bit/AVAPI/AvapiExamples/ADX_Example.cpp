...
#include "Avapi/TECHNICAL_INDICATOR/ADX.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_ADX();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_ADX_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA ADX ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA ADX ********"<< endl;
