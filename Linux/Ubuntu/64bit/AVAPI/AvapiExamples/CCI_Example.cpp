...
#include "Avapi/TECHNICAL_INDICATOR/CCI.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_CCI();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_CCI_interval::n_60min
             ,"60");

    cout << endl <<  "******** RAW DATA CCI ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA CCI ********"<< endl;
