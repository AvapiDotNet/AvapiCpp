...
#include "Avapi/TECHNICAL_INDICATOR/MINUS_DI.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_MINUS_DI();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_MINUS_DI_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA MINUS_DI ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA MINUS_DI ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "MINUS_DI: " << element.get_MINUS_DI() << endl;
