...
#include "Avapi/TECHNICAL_INDICATOR/MIDPRICE.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_MIDPRICE();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_MIDPRICE_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA MIDPRICE ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA MIDPRICE ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "MIDPRICE: " << element.get_MIDPRICE() << endl;
