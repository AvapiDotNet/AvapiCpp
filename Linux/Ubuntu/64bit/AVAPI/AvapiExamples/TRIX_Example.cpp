...
#include "Avapi/TECHNICAL_INDICATOR/TRIX.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_TRIX();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_TRIX_interval::n_60min
             ,"10"
             ,Const_TRIX_series_type::close);

    cout << endl <<  "******** RAW DATA TRIX ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA TRIX ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "TRIX: " << element.get_TRIX() << endl;
