...
#include "Avapi/TECHNICAL_INDICATOR/WILLR.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_WILLR();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_WILLR_interval::n_60min
             ,"60");

    cout << endl <<  "******** RAW DATA WILLR ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA WILLR ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "WILLR: " << element.get_WILLR() << endl;
