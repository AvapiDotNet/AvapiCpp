...
#include "Avapi/TIME_SERIES/TIME_SERIES_WEEKLY.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_TIME_SERIES_WEEKLY();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_TIME_SERIES_WEEKLY_datatype::json);

    cout << endl <<  "******** RAW DATA TIME SERIES WEEKLY ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA TIME SERIES WEEKLY ********"<< endl;
