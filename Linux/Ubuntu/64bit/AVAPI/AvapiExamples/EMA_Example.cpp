...
#include "Avapi/TECHNICAL_INDICATOR/EMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_EMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_EMA_interval::n_60min
             ,"10"
             ,Const_EMA_series_type::close);

    cout << endl <<  "******** RAW DATA EMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA EMA ********"<< endl;
