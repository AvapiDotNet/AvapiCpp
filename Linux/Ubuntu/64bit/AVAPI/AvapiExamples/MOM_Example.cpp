...
#include "Avapi/TECHNICAL_INDICATOR/MOM.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_MOM();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_MOM_interval::n_60min
             ,"60"
             ,Const_MOM_series_type::close);

    cout << endl <<  "******** RAW DATA MOM ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA MOM ********"<< endl;
