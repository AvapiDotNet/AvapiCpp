...
#include "Avapi/TECHNICAL_INDICATOR/STOCHF.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_STOCHF();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_STOCHF_interval::n_60min
             ,"2"
             ,"1"
             ,Const_STOCHF_fastdmatype::n_4);

    cout << endl <<  "******** RAW DATA STOCHF ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA STOCHF ********"<< endl;
