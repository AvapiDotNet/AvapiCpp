...
#include "Avapi/TECHNICAL_INDICATOR/DX.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_DX();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_DX_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA DX ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA DX ********"<< endl;
