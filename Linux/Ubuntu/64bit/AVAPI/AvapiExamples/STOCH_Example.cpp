...
#include "Avapi/TECHNICAL_INDICATOR/STOCH.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_STOCH();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_STOCH_interval::n_60min
             ,"4"
             ,"2"
             ,"2"
             ,Const_STOCH_slowkmatype::n_1
             ,Const_STOCH_slowdmatype::none);

    cout << endl <<  "******** RAW DATA STOCH ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA STOCH ********"<< endl;
    ...
    else
    {
        ...
        cout << "SlowKMAType: " <<  MetaData.get_SlowKMAType() << endl;
        cout << "SlowDPeriod: " <<  MetaData.get_SlowDPeriod() << endl;
        cout << "SlowDMAType: " <<  MetaData.get_SlowDMAType() << endl;
        ...
        {
            cout << "SlowK: " << element.get_SlowK() << endl;
            cout << "SlowD: " << element.get_SlowD() << endl;
