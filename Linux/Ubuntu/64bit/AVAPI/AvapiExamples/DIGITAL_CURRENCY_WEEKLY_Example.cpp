...
#include "Avapi/DIGITAL_CURRENCY/DIGITAL_CURRENCY_WEEKLY.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_DIGITAL_CURRENCY_WEEKLY();

    auto Response = QueryObject.Query(   
             "BTC"
             ,"CNY"
             ,Const_DIGITAL_CURRENCY_WEEKLY_datatype::json);

    cout << endl <<  "******** RAW DATA DIGITAL CURRENCY WEEKLY ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA DIGITAL CURRENCY WEEKLY ********"<< endl;
