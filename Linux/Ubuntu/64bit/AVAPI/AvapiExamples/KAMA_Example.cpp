...
#include "Avapi/TECHNICAL_INDICATOR/KAMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_KAMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_KAMA_interval::n_60min
             ,"10"
             ,Const_KAMA_series_type::close);

    cout << endl <<  "******** RAW DATA KAMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA KAMA ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "KAMA: " << element.get_KAMA() << endl;
