...
#include "Avapi/TECHNICAL_INDICATOR/DEMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_DEMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_DEMA_interval::n_60min
             ,"10"
             ,Const_DEMA_series_type::close);

    cout << endl <<  "******** RAW DATA DEMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA DEMA ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "DEMA: " << element.get_DEMA() << endl;
