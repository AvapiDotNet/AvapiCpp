...
#include "Avapi/TECHNICAL_INDICATOR/OBV.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_OBV();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_OBV_interval::n_60min);

    cout << endl <<  "******** RAW DATA OBV ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA OBV ********"<< endl;
