...
#include "Avapi/TECHNICAL_INDICATOR/RSI.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_RSI();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_RSI_interval::n_60min
             ,"60"
             ,Const_RSI_series_type::close);

    cout << endl <<  "******** RAW DATA RSI ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA RSI ********"<< endl;
