...
#include "Avapi/TECHNICAL_INDICATOR/AROON.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_AROON();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_AROON_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA AROON ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA AROON ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "AroonDown: " << element.get_AroonDown() << endl;
            cout << "AroonUp: " << element.get_AroonUp() << endl;
