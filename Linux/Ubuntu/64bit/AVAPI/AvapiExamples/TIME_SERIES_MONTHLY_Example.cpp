...
#include "Avapi/TIME_SERIES/TIME_SERIES_MONTHLY.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_TIME_SERIES_MONTHLY();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_TIME_SERIES_MONTHLY_datatype::json);

    cout << endl <<  "******** RAW DATA TIME SERIES MONTHLY ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA TIME SERIES MONTHLY ********"<< endl;
