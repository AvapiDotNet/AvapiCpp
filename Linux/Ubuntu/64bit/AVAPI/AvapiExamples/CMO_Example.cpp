...
#include "Avapi/TECHNICAL_INDICATOR/CMO.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_CMO();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_CMO_interval::n_60min
             ,"10"
             ,Const_CMO_series_type::close);

    cout << endl <<  "******** RAW DATA CMO ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA CMO ********"<< endl;
