...
#include "Avapi/TECHNICAL_INDICATOR/TRIMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_TRIMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_TRIMA_interval::n_60min
             ,"10"
             ,Const_TRIMA_series_type::close);

    cout << endl <<  "******** RAW DATA TRIMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA TRIMA ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "TRIMA: " << element.get_TRIMA() << endl;
