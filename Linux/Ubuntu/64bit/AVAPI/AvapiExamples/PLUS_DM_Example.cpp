...
#include "Avapi/TECHNICAL_INDICATOR/PLUS_DM.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_PLUS_DM();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_PLUS_DM_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA PLUS_DM ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA PLUS_DM ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "PLUS_DM: " << element.get_PLUS_DM() << endl;
