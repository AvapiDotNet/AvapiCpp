...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_MACD();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_MACD_interval::n_60min
             ,Const_MACD_series_type::close
             ,"16"
             ,"10"
             ,"16");

    cout << endl <<  "******** RAW DATA MACD ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA MACD ********"<< endl;
