...
#include "Avapi/TECHNICAL_INDICATOR/ATR.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_ATR();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_ATR_interval::n_60min
             ,"14");

    cout << endl <<  "******** RAW DATA ATR ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA ATR ********"<< endl;
