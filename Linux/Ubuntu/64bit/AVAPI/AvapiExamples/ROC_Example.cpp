...
#include "Avapi/TECHNICAL_INDICATOR/ROC.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_ROC();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_ROC_interval::n_60min
             ,"10"
             ,Const_ROC_series_type::close);

    cout << endl <<  "******** RAW DATA ROC ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA ROC ********"<< endl;
