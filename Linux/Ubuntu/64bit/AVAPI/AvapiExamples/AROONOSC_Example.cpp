...
#include "Avapi/TECHNICAL_INDICATOR/AROONOSC.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_AROONOSC();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_AROONOSC_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA AROONOSC ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA AROONOSC ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "AROONOSC: " << element.get_AROONOSC() << endl;
