...
#include "Avapi/TECHNICAL_INDICATOR/SMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_SMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_SMA_interval::n_60min
             ,"10"
             ,Const_SMA_series_type::close);

    cout << endl <<  "******** RAW DATA SMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA SMA ********"<< endl;
