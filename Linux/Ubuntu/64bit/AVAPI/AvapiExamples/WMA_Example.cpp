...
#include "Avapi/TECHNICAL_INDICATOR/WMA.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_WMA();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_WMA_interval::n_60min
             ,"10"
             ,Const_WMA_series_type::close);

    cout << endl <<  "******** RAW DATA WMA ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA WMA ********"<< endl;
