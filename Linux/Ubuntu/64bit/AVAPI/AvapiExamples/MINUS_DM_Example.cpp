...
#include "Avapi/TECHNICAL_INDICATOR/MINUS_DM.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_MINUS_DM();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_MINUS_DM_interval::n_60min
             ,"10");

    cout << endl <<  "******** RAW DATA MINUS_DM ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA MINUS_DM ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "MINUS_DM: " << element.get_MINUS_DM() << endl;
