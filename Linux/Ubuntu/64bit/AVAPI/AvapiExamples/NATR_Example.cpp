...
#include "Avapi/TECHNICAL_INDICATOR/NATR.hpp"
...
int main()
{
    ...
    auto& QueryObject = avapi_connection->GetQueryObject_NATR();

    auto Response = QueryObject.Query(   
             "MSFT"
             ,Const_NATR_interval::n_60min
             ,"14");

    cout << endl <<  "******** RAW DATA NATR ********"<< endl;
    cout <<  Response.get_RawData() << endl << endl;

    cout << "******** STRUCTURED DATA NATR ********"<< endl;
    ...
    else
    {
        ...
        {
            cout << "NATR: " << element.get_NATR() << endl;
